...
install: deps
	...
	@# `make install` installs the editable version of openfisca-openfisca_france.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_openfisca_france openfisca_openfisca_france/tests

serve-local: build
	openfisca serve --country-package openfisca_openfisca_france
